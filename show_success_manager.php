<html lang="en">
	...
	<section id = "section1">
		<div class="title" style="font-size: 30px;color:#ba68c8; font-size: 100%;"> Info about successful manager </div>
		<div style="margin-left:10%; margin-right:10%; margin-top:50px; margin-bottom:50px;text-align:center;">
			...
			$sql = "SELECT `mname`,`mtrophies` FROM manager WHERE `mtrophies`>10 ORDER BY mtrophies DESC";
