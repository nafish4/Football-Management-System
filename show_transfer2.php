	...
	<section id="header">
		<div class="row">  
			...
			<div class="col-md-10" style="text-align: right"> 
				...
				<a href="add_transfer2.php" style="margin-left: 20px;"> Add a new Transfer </a>
			</div>
		</div>
	</section>
	<section id = "section1">
		...
		<div style="margin-left:10%; margin-right:10%; margin-top:50px; margin-bottom:50px;text-align:center;">
			...
			<div class="row" style="padding:5px;">
				<tr>
					...
					<td>
						<form action="transfer_update2.php" method="post">
					...
					<td>
						<form action="transfer_delete2.php" method="post">
