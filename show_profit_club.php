<html lang="en">
	...
	<section id = "section1">
		<div class="title" style="font-size: 30px;color:#ba68c8; font-size: 100%;"> Info about wealthy clubs </div>
		<div style="margin-left:10%; margin-right:10%; margin-top:50px; margin-bottom:50px;text-align:center;">
			<div class="row" style="padding:5px;"> 
				<table style="width: 80%;">
					<tr>
						...
						<th><div class="col-md-3">  Revenue </div></th>
					</tr>
			...
			$sql = "SELECT `club_name`, `ticket_sale`+`shirt_sale` as revenue FROM club ORDER BY revenue DESC LIMIT 10";
