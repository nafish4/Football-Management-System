	...
	<section id="header">
		<div class="row">  
			...
			<div class="col-md-10" style="text-align: right"> 
				...
				<a href="add_manager.php" style="margin-left: 20px;"> Add Manager </a>
			...
			<div class="row" style="padding:5px;">
				<tr>
					...
					<td>
						...
						<input type="hidden" name="update_mid" value=<?php echo $row[0];?>>
						<input type="hidden" name="update_mname" value=<?php echo $row[1];?>>
						<input type="hidden" name="update_salary" value=<?php echo $row[2];?>>
						<input type="hidden" name="update_trophies" value=<?php echo $row[3];?>>
						<input type="hidden" name="update_prevclub" value=<?php echo $row[4];?>>
						<input type="submit" value="Edit">
						</form>
					</td>
					<td>
						<form action="manager_delete.php" method="post">
						<input type="hidden" name="delete_manager" value=<?php echo $row[0];?>>
