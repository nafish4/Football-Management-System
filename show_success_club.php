<html lang="en">
	...
	<section id = "section1">
		<div class="title" style="font-size: 30px;color:#ba68c8; font-size: 100%;"> Info about successful clubs </div>
		<div style="margin-left:10%; margin-right:10%; margin-top:50px; margin-bottom:50px;text-align:center;">
			...
			$sql = "SELECT `club_name`, `trophies`FROM club WHERE `trophies`>10 ORDER BY trophies DESC";
