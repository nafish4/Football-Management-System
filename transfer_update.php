...
<body>
	...
	?>
	<form action="transfer_update_work.php" method="post">
		Transfer Window:<input type="text" name="update_tw" value=<?php echo $update_tw;?>><br>
		Player name:<input type="text" name="update_pid" value=<?php echo $update_pid;?>><br>
		
		Club name:<input type="text" name="update_cid" value=<?php echo $update_cid;?>><br>
