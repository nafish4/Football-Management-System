<html lang="en">
	<head>
		<title> Info about managers </title>
	...
	<section id = "section1">
		<div class="title" style="font-size: 30px;color:#ba68c8; font-size: 100%;"> Info about wealthy manager </div>
		<div style="margin-left:10%; margin-right:10%; margin-top:50px; margin-bottom:50px;text-align:center;">
			...
			$sql = "SELECT `mname`,`man_salary` FROM manager WHERE `man_salary`>100000 ORDER BY man_salary DESC";
