<html lang="en">
	<head>
		<title> Info about injured players </title>
	...
	<section id = "section1">
		<div class="title" style="font-size: 30px;color:#ba68c8; font-size: 100%;"> Injured Players </div>
		<div style="margin-left:10%; margin-right:10%; margin-top:50px; margin-bottom:50px;text-align:center;">
			...
			$sql ="SELECT `Pname`,`injury_time`,`injury_type` FROM player WHERE injury_time!=0";
