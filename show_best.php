<html lang="en">
	<head>
		<title> Info about best players </title>
	...
	<section id = "section1">
		<div class="title"> Best Players </div>
		<div style="margin-left:10%; margin-right:10%; margin-top:50px; margin-bottom:50px;text-align:center;">
			...
			$sql ="SELECT player.Pname, club.club_name, league.league_name FROM player, club, league, statistics WHERE statistics.P_id=player.P_id AND player.club_id=club.club_id AND club.league_id=league.league_id ORDER BY statistics.goal DESC, statistics.assist DESC, player.ptrophies DESC LIMIT 10";
