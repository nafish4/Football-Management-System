<html lang="en">
	<head>
		<title> Info about most red cards </title>
	...
	<section id = "section1">
		<div class="title" style="font-size: 30px;color:#ba68c8; font-size: 100%;"> Most Red Cards </div>
		<div style="margin-left:10%; margin-right:10%; margin-top:50px; margin-bottom:50px;text-align:center;">
			...
			$sql ="SELECT player.Pname, club.club_name, league.league_name, statistics.red_card FROM player, club, league, statistics WHERE statistics.P_id=player.P_id AND player.club_id=club.club_id AND club.league_id=league.league_id ORDER BY statistics.red_card DESC LIMIT 10";
